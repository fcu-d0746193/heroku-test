...
def where_gym(message):
    ...
    foodStoreSearch = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?key={}&location={},{}&rankby=distance&type=gym&language=zh-TW&keyword=健身房".format(GOOGLE_API_KEY,lat,lng)
